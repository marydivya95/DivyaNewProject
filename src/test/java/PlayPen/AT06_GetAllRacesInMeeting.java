...
public class AT06_GetAllRacesInMeeting {
    @Test
    public void RacesInMeeting() throws InterruptedException, NoSuchFieldException {
...
// put into hashmap
        ...
        for (Map.Entry<Object, Object> entry : map.entrySet()) {
            if (entry.getKey() != null) {
                ...
                String url = "https://api.congo.beta.tab.com.au/v1/tab-info-service/racing/dates/2022-05-17/meetings/" + v + "/" + k + "/races?jurisdiction=VIC";
