...
public class AT06_GetAllRacesInMeeting {
    @Test
    public void RacesCount() throws InterruptedException, NoSuchFieldException {

          Response response= RestAssured.given()
                .when()
                .get("https://api.congo.beta.tab.com.au/v1/tab-info-service/racing/dates/2022-05-18/meetings/R/BRK/races?jurisdiction=VIC")
                .then()
...
//        //Get venueMnemonic [This is a Array]
        List raceNumber= jsXpath.get("races.raceNumber");
        ...
        for(int i=0;i<raceNumberCount;i++){
           System.out.println(raceNumber.get(i));
...
//
//                String url = "https://api.congo.beta.tab.com.au/v1/tab-info-service/racing/dates/2022-05-18/meetings/" + v + "/" + k + "/races?jurisdiction=VIC";
